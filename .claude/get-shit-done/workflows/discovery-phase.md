...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /gsa:research-phase instead, which produces RESEARCH.md.
</purpose>
...
1. Discuss phase context (/gsa:discuss-phase [current-phase])
2. Create phase plan (/gsa:plan-phase [current-phase])
