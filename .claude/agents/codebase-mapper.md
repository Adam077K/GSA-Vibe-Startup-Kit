...
- `product-manager-toolkit` — Roadmaps, success criteria, goal-backward
- `domain-driven-design` — Strategic domain decomposition
- `architecture-decision-records` — Documenting key architectural decisions
- `brainstorming` — Problem decomposition before planning
- `architecture` — Architectural decision-making framework
- `production-code-audit` — Deep codebase analysis for mapping
</recommended_skills>
