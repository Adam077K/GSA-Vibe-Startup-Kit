...
- `e2e-testing-patterns` — E2E flow verification patterns
- `testing-patterns` — Integration test patterns and coverage
- `find-bugs` — Finding wiring gaps and integration bugs
- `api-design-principles` — Understanding API contracts to verify
- `production-code-audit` — Deep scan for quality issues
</recommended_skills>
