...
<recommended_skills>
### Research
- `deep-research` — Multi-step research with source quality assessment
- `competitive-landscape` — Ecosystem and competitor analysis
- `search-specialist` — Advanced web research techniques
- `market-sizing-analysis` — Market sizing for domain analysis
- `startup-metrics-framework` — SaaS metrics for market understanding
- `data-storytelling` — Synthesizing research into actionable insights
</recommended_skills>
