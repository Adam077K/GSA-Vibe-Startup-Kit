...
<recommended_skills>
### Validation & Testing
- `testing-patterns` — Jest/Vitest test writing patterns
- `e2e-testing-patterns` — Playwright E2E test patterns
- `tdd-workflow` — TDD methodology for filling validation gaps
- `playwright-skill` — Browser automation for validation
- `unit-testing-test-generate` — Generating comprehensive test coverage
</recommended_skills>
