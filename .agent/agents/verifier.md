...
- `systematic-debugging` — Scientific debugging with hypothesis testing
- `debugging-strategies` — Profiling, logging, and tracing strategies
- `find-bugs` — Systematic bug and vulnerability identification
- `error-handling-patterns` — Understanding error patterns and root causes
- `production-code-audit` — Deep scan for production code issues
</recommended_skills>
