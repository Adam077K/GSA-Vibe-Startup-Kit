...
<recommended_skills>
### Planning
- `product-manager-toolkit` — Goal-backward methodology, user stories, success criteria
- `architecture-decision-records` — Documenting technical decisions in plans
- `domain-driven-design` — Understanding system boundaries for planning
- `brainstorming` — Decomposing complex requirements before planning
- `architecture-patterns` — Backend architecture for technical task planning
</recommended_skills>
