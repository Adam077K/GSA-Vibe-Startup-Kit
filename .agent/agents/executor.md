...
<recommended_skills>
### Execution
- `using-git-worktrees` — Worktree isolation for parallel execution
- `commit` — Conventional commit format for atomic commits
- `finishing-a-development-branch` — Completing feature branches properly
- `cc-skill-coding-standards` — Coding standards to uphold during execution
- `error-handling-patterns` — Adding missing error handling automatically
</recommended_skills>
